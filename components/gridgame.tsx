...
function setAnswer(e: number) {
    ...
    questionElement = allElements[choices[index]].name;
...
const GridGame = () => {
    ...
    const [nameOne, setNameOne] = useState(allElements[choices[0]].name);
    ...
    const [stateOne, setStateOne] = useState(allElements[choices[0]].state);
    ...
    const [nameTwo, setNameTwo] = useState(allElements[choices[1]].name);
    ...
    const [stateTwo, setStateTwo] = useState(allElements[choices[1]].state);
    ...
    const [nameThree, setNameThree] = useState(allElements[choices[2]].name);
    ...
    const [stateThree, setStateThree] = useState(allElements[choices[2]].state);
    ...
    const [nameFour, setNameFour] = useState(allElements[choices[3]].name);
    ...
    const [stateFour, setStateFour] = useState(allElements[choices[3]].state);
    ...
    const [nameFive, setNameFive] = useState(allElements[choices[4]].name);
    ...
    const [stateFive, setStateFive] = useState(allElements[choices[4]].state);
    ...
    const [nameSix, setNameSix] = useState(allElements[choices[5]].name);
    ...
    const [stateSix, setStateSix] = useState(allElements[choices[5]].state);
    ...
    function setElements() {
        ...
        setNameOne(allElements[choices[0]].name);
        setNameTwo(allElements[choices[1]].name);
        setNameThree(allElements[choices[2]].name);
        setNameFour(allElements[choices[3]].name);
        setNameFive(allElements[choices[4]].name);
        setNameSix(allElements[choices[5]].name);
        ...
        setStateOne(allElements[choices[0]].state);
        setStateTwo(allElements[choices[1]].state);
        setStateThree(allElements[choices[2]].state);
        setStateFour(allElements[choices[3]].state);
        setStateFive(allElements[choices[4]].state);
        setStateSix(allElements[choices[5]].state);
    ...
    return (
        <div id={styles.container}>
            <div id={styles.question}>Which symbol belongs to the element <span style={{fontWeight: 'bold', color: '#0097ff'}}>{questionElement}</span>?</div>
