...
// Randomizes elements pulled for the game
...
// Turns the front of the card over
...
// Turns the back of the card over
...
// Turns the card over based on its current position
...
const MatchGame = () => {
    ...
    function resetClasses() {
        ...
        const unflippedCards = document.querySelectorAll(`.${styles.unflip}`);
        ...
        unflippedCards.forEach(unflippedCard => {
            unflippedCard.classList.remove(`${styles.unflip}`);
        })
    }
